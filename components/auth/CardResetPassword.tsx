        ...
        <div className="min-h-screen flex items-center justify-center p-6 bg-[#1e1e20] relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-[#1e1e20] border border-white/10 rounded-2xl p-8 shadow-2xl relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Digite seu e-mail e enviaremos um link para redefinir sua senha</p>
                </div>

                <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                    <div className="space-y-2">
                        <label htmlFor="reset-email" className="text-sm font-medium text-gray-300">E-mail</label>
                        <input
                            ref={emailRef}
                            id="reset-email"
                            name="email"
                            ...
                            className={`w-full px-4 py-3 rounded-xl bg-white/5 border ${error ? 'border-red-500/50 focus:border-red-500' : 'border-white/10 focus:border-purple-500'} text-white placeholder-gray-500 outline-none transition-all`}
                            aria-invalid={!!error}
                            autoComplete="email"
                            required
                        />
